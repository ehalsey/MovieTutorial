namespace MovieTutorial.App {
    ...
    export namespace MovieCastRow {
        ...
        export const localTextPrefix = 'App.MovieCast';
        ...
        ['MovieCastId', 'MovieId', 'PersonId', 'Character', 'MovieTitle', 'MovieDescription', 'MovieStoryline', 'MovieYear', 'MovieReleaseDate', 'MovieRuntime', 'MovieKind', 'MovieTestField', 'PersonFirstname', 'PersonLastname', 'PersonBirthDate', 'PersonBirthPlace', 'PersonGender', 'PersonHeight', 'PersonFullname'].forEach(x => (<any>Fields)[x] = x);
    }
}
