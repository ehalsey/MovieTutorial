...
namespace MovieTutorial.App.Entities
{
    using Serenity;
    ...
    [ConnectionKey("MovieTutorial"), TableName("[mov].[MovieGenres]"), DisplayName("Movie Genres"), InstanceName("Movie Genres"), TwoLevelCached]
    ...
    public sealed class MovieGenresRow : Row, IIdRow
    {
        ...
        [DisplayName("Movie Test Field"), Expression("jMovie.[TestField]")]
        public String MovieTestField
        {
            get { return Fields.MovieTestField[this]; }
            set { Fields.MovieTestField[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField MovieTestField;
            ...
            public RowFields()
                : base()
            {
                LocalTextPrefix = "App.MovieGenres";
            }
        }
    }
}
